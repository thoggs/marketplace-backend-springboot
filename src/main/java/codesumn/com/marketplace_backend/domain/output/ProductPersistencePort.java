...
public interface ProductPersistencePort {
    Page<ProductModel> findAllWithSpecAndPageable(Specification<ProductModel> specification, Pageable pageable);

    Page<ProductModel> findAllWithPageable(Pageable pageable);
